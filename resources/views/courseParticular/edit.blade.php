        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    <div class="panel-heading">Update Course Particular</div>

                    <div class="panel-body">
                        {!! Form::model($courseParticular, array('route'=>['courseParticular.update', $courseParticular->courseID],'method'=>'PUT')) !!}
